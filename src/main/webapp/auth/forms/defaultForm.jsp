...
<br/>
        ...
        <button class="btn btn-lg btn-danger btn-block" type="button" name="forgotpassword" id="forgotpassword" onclick="window.location='/passwordreset/index.html'">Forgot Password</button>
